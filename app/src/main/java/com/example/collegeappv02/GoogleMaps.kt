...
class GoogleMaps : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        val sunway = LatLng(3.0671, 101.6035)
        mMap.addMarker(MarkerOptions().position(sunway).title("Sunway University"))
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(sunway, 15f))
    }
}