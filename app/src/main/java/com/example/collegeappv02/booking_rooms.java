...
public class booking_rooms extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), view_booking_rooms.class);
                startActivity(intent);
                finish();
            }
        });
                ...
                if(!student_id.equals("") && !rooms_id.equals("") && !date.equals("") && !startingtime.equals("") && !endingtime.equals("")) {
                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            data[3] = startingtime;
                            data[4] = endingtime;
                            PutData putData = new PutData("http://YOUR_IP_HERE/CA_database/booking_rooms.php", "POST", field, data);
                            if (putData.startPut()) {
